...
public class IdepixO2CloudOp extends Operator {
        ...
        try {
            for (int y = targetRectangle.y; y < targetRectangle.y + targetRectangle.height; y++) {
                ...
                for (int x = targetRectangle.x; x < targetRectangle.x + targetRectangle.width; x++) {
                    ...
                    final IdepixO2Correction o2Corr =
                            IdepixO2Correction.computeO2CorrectionTerms(cameraBounds, x, trans13, altitude,
                                                                        sza, oza, isBright);
