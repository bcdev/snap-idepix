...
public class IdepixOlciUtils {
    ...
    public static Product computeCloudTopPressureProduct(Product sourceProduct, Product o2CorrProduct, Product idepixProduct, String alternativeNNDirPath, boolean outputCtp) {
