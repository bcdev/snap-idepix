 ...
 * @author olafd
 */
public class IdepixO2Correction {
    private double trans13Baseline;
    private double trans13BaselineAmfCorr;
    private double trans13Excess;
    private boolean isO2Cloud;

    public IdepixO2Correction(double trans13Baseline, double trans13BaselineAmfCorr, double trans13Excess, boolean isO2Cloud) {
     ...
     */
    public static IdepixO2Correction computeO2CorrectionTerms(int[] cameraBounds, int x, double trans13, double altitude,
        ...
        return new IdepixO2Correction(trans13Baseline, trans13BaselineAMFcorr13, trans13Excess, isO2Cloud);
    }
