 ...
 * @author olafd
 */
@OperatorMetadata(alias = "Snap.Idepix.TerraAqua.Modis.Postprocess",
        version = "3.0",
...
public class IdepixModisPostProcessOp extends BasisOp {
    ...
    private boolean refineCloudFlaggingForCoastlines(int x, int y, Tile sourceFlagTile, Tile waterFractionTile, Tile targetTile, Rectangle rectangle) {
        ...
        if (removeCloudFlag) {
            ...
            targetTile.setSample(x, y, IdepixModisConstants.IDEPIX_MIXED_PIXEL, !is_land);
        }
...
//                if (!is_already_cloud && rectangle.contains(i, j)) {
    ...
    public static class Spi extends OperatorSpi {
        ...
        public Spi() {
            super(IdepixModisPostProcessOp.class);
        }
    }
