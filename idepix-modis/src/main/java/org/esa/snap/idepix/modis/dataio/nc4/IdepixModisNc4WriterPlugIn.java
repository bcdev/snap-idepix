...
/**
 * Writer plugin for IdePix MODIS NetCDF4 output with all overhead stripped
 * (i.e. keep products as small as possible, no metadata is written)
 *
 * @author olafd
 */
public class IdepixModisNc4WriterPlugIn extends AbstractNetCdfWriterPlugIn {

    public String[] getFormatNames() {
        return new String[]{"NetCDF4-IDEPIX-MODIS"};
    }
    ...
    public String getDescription(Locale locale) {
        return "SNAP IDEPIX-MODIS NetCDF4 products";
    }
...
//                }
        ...
        private void addGlobalAttributes(NFileWriteable writeable, Product product) throws IOException {
            ...
            writeable.addGlobalAttribute("title", "IdePix MODIS product");
