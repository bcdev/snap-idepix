...
/**
 * Modification of BeamMaskPart for IdePix MODIS purposes
 *
 * @author olafd
 */
public class IdepixModisMaskPart extends BeamMaskPart {

    private static final String IDEPIX_MODIS_MASK_PREFIX = "idepix_modis";
    ...
    private static void writeMasks(Product p, NFileWriteable ncFile) throws IOException {
        ...
        for (String maskName : maskNames) {
            if (maskName.startsWith(IDEPIX_MODIS_MASK_PREFIX)) {
