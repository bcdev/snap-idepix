...
/**
 * Idepix AVHRR constants
 *
 * @author olafd
 */
class AvhrrConstants {

    static final String AVHRR_AC_ALBEDO_1_BAND_NAME = "albedo_1";
    private static final String AVHRR_AC_ALBEDO_2_BAND_NAME = "albedo_2";
    static final String[] AVHRR_AC_ALBEDO_BAND_NAMES = {
    ...
    static final String[] AVHRR_AC_RADIANCE_BAND_NAMES = {
    ...
    static final double[] EW_3b = {278.85792,284.69366};
    static final double[] A0 = {6.34384,4.00162};
    static final double[] B0 = {2.68468,0.98107};
    static final double[] C0 = {-1.70931,1.9789};
    static final double[] a1_3b = {-1.738973,-1.88533};
    static final double[] a2_3b = {1.003354,1.003839};
    ...
    static final double TGCT_THRESH = 260.0;

    static final double EMISSIVITY_THRESH = 0.022;
    static final double LAT_MAX_THRESH = 60.0;

    static double[] fmftTestThresholds = new double[] {
    ...
    static double[] tmftTestMaxThresholds = new double[] {
    ...
    static double[] tmftTestMinThresholds = new double[] {
