...
class SlstrUtils {
    ...
    static String installAuxdataNNCtp() throws IOException {
        ...
        final Path sourceDirPath = ResourceInstaller.findModuleCodeBasePath(SlstrCtpOp.class).resolve("auxdata/nn_ctp");
    ...
    static double getRefinedHeightFromCtp(double ctp, double slp, double[] temperatures) {
        double height = 0.0;
        final double[] prsLevels = SlstrConstants.referencePressureLevels;
    ...
    static Product computeCloudTopPressureProduct(Product sourceProduct, Product o2CorrProduct) {
        ...
        return GPF.createProduct(OperatorSpi.getOperatorAlias(SlstrCtpOp.class), params, ctpSourceProducts);
    }
