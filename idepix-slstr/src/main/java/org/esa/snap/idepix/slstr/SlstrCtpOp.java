...
public class SlstrCtpOp extends BasisOp {
    ...
    private SlstrTensorflowNNCalculator nnCalculator;
    ...
    public void initialize() throws OperatorException {
        ...
        String modelDir = auxdataPath + File.separator + SlstrCtpOp.DEFAULT_TENSORFLOW_NN_DIR_NAME;
        ...
        nnCalculator = new SlstrTensorflowNNCalculator(modelDir, "none");
        ...
        for (int y = targetRectangle.y; y < targetRectangle.y + targetRectangle.height; y++) {
            ...
            for (int x = targetRectangle.x; x < targetRectangle.x + targetRectangle.width; x++) {
                ...
                if (pixelIsValid) {
                    ...
                    final float ctp = SlstrTensorflowNNCalculator.convertNNResultToCtp(nnResult[0][0]);
