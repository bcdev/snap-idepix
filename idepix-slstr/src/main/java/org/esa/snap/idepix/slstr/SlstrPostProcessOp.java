...
public class SlstrPostProcessOp extends Operator {
    ...
    public void computeTile(Band targetBand, final Tile targetTile, ProgressMonitor pm) throws OperatorException {
        ...
        if (computeCloudShadow && ctpProduct != null) {
            ...
            SlstrCloudShadowFronts cloudShadowFronts = new SlstrCloudShadowFronts(geoCoding,
                    szaTile, saaTile,
                    ozaTile, oaaTile,
                    ctpTile, slpTile,
    ...
    public static class Spi extends OperatorSpi {
        ...
        public Spi() {
            super(SlstrPostProcessOp.class);
        }
    }
