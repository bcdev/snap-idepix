...
public class SlstrOp extends BasisOp {
    ...
    public void initialize() throws OperatorException {
        ...
        SlstrUtils.copySlstrCloudFlagBands(sourceProduct, olciSlstrIdepixProduct);
...
//        ProductUtils.copyMetadata(idepixProduct, targetProduct);
        ...
        SlstrUtils.setupOlciClassifBitmask(targetProduct);
    ...
    private void preProcess() {
        olciRad2reflProduct = SlstrUtils.computeRadiance2ReflectanceProduct(sourceProduct, Sensor.SLSTR_500m);
        ...
        if (computeCloudShadow) {
            ...
            ctpProduct = SlstrUtils.computeCloudTopPressureProduct(sourceProduct, o2CorrProduct);
        }
    }
    ...
    private Product computeClassificationProduct() {
        ...
        return GPF.createProduct(OperatorSpi.getOperatorAlias(SlstrClassificationOp.class),
    ...
    private void postProcess(Product olciIdepixProduct) {
        ...
        postProcessingProduct = GPF.createProduct(OperatorSpi.getOperatorAlias(SlstrPostProcessOp.class),
                                                  params, input);
    }
