...
public class OlciSlstrCtpOp extends BasisOp {
    ...
    private OlciSlstrTensorflowNNCalculator nnCalculator;
    ...
    public void initialize() throws OperatorException {
        ...
        String auxdataPath;
        try {
            auxdataPath = OlciSlstrUtils.installAuxdataNNCtp();
        } catch (IOException e) {
            e.printStackTrace();
            throw new OperatorException("Cannot install CTP NN auxdata:" + e.getMessage());
        }

        String modelDir = auxdataPath + File.separator + OlciSlstrCtpOp.DEFAULT_TENSORFLOW_NN_DIR_NAME;
        ...
        nnCalculator = new OlciSlstrTensorflowNNCalculator(modelDir, "none");
    ...
    public void computeTile(Band targetBand, Tile targetTile, ProgressMonitor pm) throws OperatorException {
        ...
        for (int y = targetRectangle.y; y < targetRectangle.y + targetRectangle.height; y++) {
            ...
            for (int x = targetRectangle.x; x < targetRectangle.x + targetRectangle.width; x++) {
                ...
                final boolean pixelIsValid = !l1FlagsTile.getSampleBit(x, y, OlciSlstrConstants.L1_F_INVALID);
                if (pixelIsValid) {
                    ...
                    final float ctp = OlciSlstrTensorflowNNCalculator.convertNNResultToCtp(nnResult[0][0]);
