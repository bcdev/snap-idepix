 ...
 * @author Marco Peters
 */
class C3SOlciSlstrCloudNNInterpreter {
...
//    private static final ValueRange CLEAR_WATER_BOUNDS = new ValueRange(5.46, 6.00, true, false);
    ...
    private C3SOlciSlstrCloudNNInterpreter() {
    }

    // Here we might add the nn as parameter to decide which valueRanges to load
    static C3SOlciSlstrCloudNNInterpreter create() {
        return new C3SOlciSlstrCloudNNInterpreter();
    }
